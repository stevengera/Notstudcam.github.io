  ...
  <section id="container">
    ...
    <div class="table-responsive">
        <div class="row mt">
          ...
          <form action="BDDSUP_note.php" method="POST">
                <table>
                    <tr>
                            <h4> VEILLEZ ENTRER LE MATRICULE DE L'ETUDIANT A SUPPRIMER </h4>
							<td><label for="Matricule">MATRICULE : </label></td>	
							<td><?php echo '<br/>';?><input type="text" name="Matricule"  /><?php echo '<br/><br/>';?></td>
					</tr>
					<tr>
					       <td><?php echo '<br/>';?><input type="submit" value="supprimer" /></td> 	
					</tr>
               </table>
            </form>
