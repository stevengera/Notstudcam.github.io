...
require 'BDD_note.php';

?>         
             <div id="block_form">
             <form action="BDD_note.php" method="POST"><br/><br/><br/>
             <table>   
                <fieldset>
                
                     <h4> VEILLEZ ENTRER LES NOTES DES ETUDIANTS </h4><br/>
                     <tr>
                  ...
                  <td><input type="number" name="ALGEBRE"/></td><br/><br/><br/>
                    ...
                    <tr>
                  <td><h4><input type="submit" value="Ajouter" /></h4></td>                      
                    </tr>             
